...
namespace CompucareWard.iOS.Helpers
{
    public static class ImageHelper
    {
        public static UIImage ImageFromFont(string text, UIColor iconColor, CGSize iconSize, string fontName = "Font Awesome 5 Pro")
        {
